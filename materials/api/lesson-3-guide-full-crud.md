...
// Check a plaintext attempt against a stored hash (used at login — Lesson 6)
...
Insomnia setup (import, `baseUrl`) was covered in the Lesson 2 guide,
