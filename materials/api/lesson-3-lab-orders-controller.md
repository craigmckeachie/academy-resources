# Lesson 3 Lab — OrdersController (Nested Data)
...
> The `StaffId` and `MenuItemId` values above assume the seed ids from the Lesson 1
> and Lesson 2 labs. If your ids differ, adjust them to point at rows that exist.
